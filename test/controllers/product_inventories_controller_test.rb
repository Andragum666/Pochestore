...
class ProductInventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_inventory" do
    assert_difference('ProductInventory.count') do
      post product_inventories_url, params: { product_inventory: { inventory_id: @product_inventory.inventory_id, product_id: @product_inventory.product_id, quantity: @product_inventory.quantity } }
    end
  ...
  test "should update product_inventory" do
    patch product_inventory_url(@product_inventory), params: { product_inventory: { inventory_id: @product_inventory.inventory_id, product_id: @product_inventory.product_id, quantity: @product_inventory.quantity } }
